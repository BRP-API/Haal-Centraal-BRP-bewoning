...
Rule: adresseerbaarObjectIdentificatie of burgerservicenummer parameter zijn verplicht
    ...
    Scenario: burgerservicenummer of adresseerbaarobjectidentificatie parameter is niet opgegeven
        ...
        '''
        {
            ...
            "status": 400,
            "code": "paramsRequired",
            "instance": "/bewoningenhistorie?fields=bewoningen.periode"
        }
        '''
...
Rule: opgeven van datumVan en/of datumTotEnMet parameters en peildatum parameter is niet toegestaan
    ...
    Abstract Scenario: <parameters> parameters zijn opgegeven
        Als de endpoint '/bewoningenhistorie' met query string '<query string>&burgerservicenummer=99999XXXX&fields=bewoningen.periode' wordt aangeroepen
        Dan bevat de response de JSON fragment
        '''
        {
            ...
            "instance": "/bewoningenhistorie?<query string>&burgerservicenummer=99999XXXX&fields=bewoningen.periode"
        }
        '''
...
Rule: datumVan, datumTotEnMet en peildatum parameters mogen niet in de toekomst liggen
    ...
    Abstract Scenario: <parameter> parameter is een datum in de toekomst
        ...
        '''
        {
            "title": "Eén of meerdere parameters zijn niet correct.",
            "status": 400,
            "instance": "/bewoningenhistorie?burgerservicenummer=99999XXXX&fields=bewoningen.periode&<parameter>=2021-11-19",
            "invalidParams": [
                {
                    "name": "<parameter>",
                    "code": "invalidValue",
...
Rule: datumVan moet voor datumTotEnMet liggen
    ...
    Scenario: datumVan ligt na datumTotEnMet
        ...
        '''
        {
            "title": "Eén of meerdere parameters zijn niet correct.",
            "status": 400,
            "instance": "/bewoningenhistorie?datumVan=2020-08-02&datumTotEnMet=2020-08-01&fields=bewoningen.periode",
            "invalidParams": [
                "name": "datumVan",
                "code": "range",
...
Rule: datumVan en datumTotEnMet zijn standaard gelijk aan de datum van vandaag
    ...
    Scenario: datumVan is niet opgegeven en datumTotEnMet is opgegeven
        ...
        '''
        {
            "title": "Eén of meerdere parameters zijn niet correct.",
            "status": 400,
            "instance": "/bewoningenhistorie?adresseerbaarobjectidentificatie=0518010000781379&datumTotEnMet=2020-08-01&fields=bewoningen.periode",
            "invalidParams": [
                "name": "datumVan",
                "code": "range",
