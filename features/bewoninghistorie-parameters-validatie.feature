...
Rule: adresseerbaarObjectIdentificatie of burgerservicenummer parameter zijn verplicht
    ...
    Scenario: burgerservicenummer of adresseerbaarobjectidentificatie parameter is niet opgegeven
        ...
        '''
        {
            ...
            "status": 400,
            "code": "paramsRequired",
            "instance": "/bewoningenhistorie?fields=bewoningenhistorie"
        }
        '''
...
Rule: opgeven van datumVan en/of datumTotEnMet parameters en peildatum parameter is niet toegestaan
    ...
    Abstract Scenario: <parameters> parameters zijn opgegeven
        Als de endpoint '/bewoningenhistorie' met query string '<query string>&burgerservicenummer=99999XXXX&fields=bewoningenhistorie' wordt aangeroepen
        Dan bevat de response de volgende Problem JSON fragment
        '''
        {
            ...
            "instance": "/bewoningenhistorie?<query string>&burgerservicenummer=99999XXXX&fields=bewoningenhistorie"
        }
        '''
...
Rule: datumVan moet voor datumTotEnMet liggen
    ...
    Scenario: datumVan ligt na datumTotEnMet
        ...
        '''
        {
            "title": "Eén of meerdere parameters zijn niet correct.",
            "status": 400,
            "instance": "/bewoningenhistorie?datumVan=2020-08-02&datumTotEnMet=2020-08-01&fields=bewoningenhistorie",
            "invalidParams": [
                "name": "datumVan",
                "code": "range",
...
Rule: datumVan en datumTotEnMet zijn standaard gelijk aan de datum van vandaag
    ...
    Scenario: datumVan is niet opgegeven en datumTotEnMet is opgegeven
        ...
        '''
        {
            "title": "Eén of meerdere parameters zijn niet correct.",
            "status": 400,
            "instance": "/bewoningenhistorie?datumTotEnMet=2020-08-01&fields=bewoningenhistorie",
            "invalidParams": [
                "name": "datumVan",
                "code": "range",
