...
Rule: een persoon met aanduiding in onderzoek waarde '089999' wordt niet geleverd als bewoner vanaf de ingangsdatum van het onderzoek
  ...
  Scenario: persoon verblijft niet meer op het gevraagde adres en is inmiddels ingeschreven op een ander adres
    Gegeven adres 'A1' heeft de volgende gegevens
    | gemeentecode (92.10) | identificatiecode verblijfplaats (11.80) |
    | 0800                 | 0800010000000001                         |
  ...
  Scenario: persoon verblijft niet meer op het gevraagde adres en is inmiddels ingeschreven met onbekende verblijfplaats en gedeeltelijk onbekende vertrekdatum
    Gegeven adres 'A1' heeft de volgende gegevens
    | gemeentecode (92.10) | identificatiecode verblijfplaats (11.80) |
    | 0800                 | 0800010000000001                         |
    En de persoon met burgerservicenummer '000000024' is ingeschreven op adres 'A1' met de volgende gegevens
...
Rule: een beëindigd onderzoek met de waarde '089999' bij een persoon wordt niet gebruikt
  ...
  Abstract Scenario: persoon verblijft niet meer op het gevraagde adres en <scenario>
    ...
    | peildatum  | periode                   | scenario                                                                                                            |
    | 2022-01-01 | 2022-01-01 tot 2022-01-02 | peildatum valt voor de datum ingang onderzoek                                                                       |
    | 2022-07-12 | 2022-07-12 tot 2022-07-13 | peildatum valt na de dag ingang onderzoek en voor datum einde onderzoek                                             |
    ...
    | 2022-09-12 | 2022-09-12 tot 2022-09-13 | peildatum valt na datum aanvang volgende verblijfplaats                                                             |
