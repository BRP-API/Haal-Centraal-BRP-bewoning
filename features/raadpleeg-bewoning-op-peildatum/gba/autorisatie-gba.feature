...
Functionaliteit: autorisatie voor het gebruik van de API BewoningMetPeildatum
  ...
  Voorlopig wordt de BewoningMetPeildatum API alleen aangeboden aan gemeenten voor het raadplegen van adresseerbare object binnen de eigen gemeente.
  ...
  Rule: Een gemeente als afnemer is geautoriseerd voor het bevragen van bewoning van een adresseerbaar object binnen de eigen gemeente.
    ...
    Scenario: Gemeente raadpleegt bewoning van een adresseerbaar object buiten de gemeente en een bewoner op peildatum is nu wel ingeschreven in de gemeente.
      ...
      | code     | unauthorized                                                                |
      | instance | /haalcentraal/api/bewoning/reisdocumenten                             |
