...
Rule: bevragen van bewoning van een samengevoegd/gesplitst verblijfsobject op een datum vóór de splitsing/samenvoeging levert bewoning van de samengevoegde/gesplitste verblijfsobject(en) op de gevraagde peildatum
