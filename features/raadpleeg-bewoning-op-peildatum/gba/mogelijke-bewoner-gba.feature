...
Functionaliteit: mogelijke bewoner bij onzekere begin- of einddatum van het verblijf
  ...
  Rule: een persoon is geen bewoner van een adresseerbaar object wanneer de datum aanvang onbekend is, maar de peildatum ligt na de datum aanvang van een volgend verblijf
