...
Rule: een persoon dat verblijft op de gevraagde adresseerbaar object met onbekende aanvang adreshouding, geen vorige en volgende adreshouding, is op peildatum een mogelijke bewoner als de peildatum in de onzekerheidsperiode van de gevraagde adreshouding ligt
