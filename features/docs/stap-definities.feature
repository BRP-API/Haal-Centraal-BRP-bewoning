...
Rule: Gegeven de persoon met burgerservicenummer '<bsn>' heeft de volgende '<categorie>' gegevens
  ...
  Scenario: gegeven de persoon heeft adres als briefadres opgegeven met de volgende gegevens
    Gegeven adres 'A1' heeft de volgende gegevens
    | straatnaam (11.10) |
    | Boterdiep          |
  ...
  Scenario: gegeven de persoon heeft vervolgens adres als briefadres opgegeven met de volgende gegevens
    Gegeven adres 'A1' heeft de volgende gegevens
    | straatnaam (11.10) |
    | Boterdiep          |
    En de persoon met burgerservicenummer '000000012' is ingeschreven op adres 'A1' met de volgende gegevens
    | gemeente van inschrijving (09.10) | datum aanvang adreshouding (10.30) |
    | 0800                              | 20220102                           |
    En de persoon heeft vervolgens adres 'A1' als briefadres opgegeven met de volgende gegevens
    | datum aanvang adreshouding (10.30) |
    | 20230102                           |
    Dan zijn de gegenereerde SQL statements
    | stap | categorie      | text                                                                                                                                                         | values                      |
