...
Functionaliteit: Stap definities
  ...
  Om scenarios voor de BRP APIS te kunnen schrijven wordt in deze feature beschreven welke sql statements worden gegeneerd/uitgevoerd voor een Gegeven stap.
...
Rule: Gegeven de persoon met burgerservicenummer '<bsn>' heeft de volgende '<categorie>' gegevens
  ...
  Scenario: een inschrijving op een adres (oude manier)
  ...
  Scenario: een inschrijving op een adres (nieuwe manier)
    Gegeven een adres heeft de volgende gegevens
    | straatnaam (11.10) |
    | Boterdiep          |
  ...
  Scenario: een verhuizing (oude manier)
    Gegeven de persoon met burgerservicenummer '000000012' heeft de volgende 'verblijfplaats' gegevens
    | datum aanvang adreshouding (10.30) |
    | 20230102                           |
    En de 'verblijfplaats' heeft de volgende 'adres' gegevens
  ...
  Scenario: een verhuizing (nieuwe manier)
    ...
    | locatiebeschrijving (12.10) |
    | Woonboot bij de Grote Sloot |
    En de persoon met burgerservicenummer '000000012' is ingeschreven op het 1e adres met de volgende gegevens
    | datum aanvang adreshouding (10.30) |
    | 20230102                           |
