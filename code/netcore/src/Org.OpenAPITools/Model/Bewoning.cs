...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Bewoning")]
    public partial class Bewoning : IEquatable<Bewoning>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Bewoning" /> class.
        /// </summary>
        ...
        public Bewoning(string adresseerbaarObjectIdentificatie = default(string), List<Bewoner> bewoners = default(List<Bewoner>), bool indicatieVeelBewoners = default(bool), List<AdresUitgebreid> adressen = default(List<AdresUitgebreid>))
        {
        ...
        {
            return this.Equals(input as Bewoning);
        }

        /// <summary>
        /// Returns true if Bewoning instances are equal
        /// </summary>
        /// <param name="input">Instance of Bewoning to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Bewoning input)
        {
            if (input == null)
                return false;
