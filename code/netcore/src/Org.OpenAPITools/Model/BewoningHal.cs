...
namespace Org.OpenAPITools.Model
{
    ...
    /// BewoningHal
    /// </summary>
    [DataContract(Name = "BewoningHal")]
    public partial class BewoningHal : IEquatable<BewoningHal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BewoningHal" /> class.
        /// </summary>
        ...
        public BewoningHal(string adresseerbaarObjectIdentificatie = default(string), List<Bewoner> bewoners = default(List<Bewoner>), bool indicatieVeelBewoners = default(bool), List<AdresUitgebreid> adressen = default(List<AdresUitgebreid>), BewoningLinks links = default(BewoningLinks), BewoningEmbedded embedded = default(BewoningEmbedded))
        {
        ...
        {
            return this.Equals(input as BewoningHal);
        }

        /// <summary>
        /// Returns true if BewoningHal instances are equal
        /// </summary>
        /// <param name="input">Instance of BewoningHal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BewoningHal input)
        {
            if (input == null)
                return false;
