...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BewoningApi()
        api_instance.get_bewoning  # this is an instance of the class Endpoint
        api_instance.get_bewoning()  # this invokes api_instance.get_bewoning.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_bewoning.callable or self.callable in this class
